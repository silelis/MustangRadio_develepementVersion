...
//--------------------------------------------------------------//
            ...
            // !!!!!!!!!!!!!! variabnles used only to save data !!!!!!!!!!!!!! 
            signed int8 EQU_Backlight_val_temp=EQU_Backlight_value;                       //zmienna pamiêta jaka jest wartoœæ na pocz¹tu - potrzebne w celu zapisu do EEprom
            signed int8 EQU_use_active_antena_val_temp=EQU_use_active_antena_val;         //zmienna pamiêta jaka jest wartoœæ na pocz¹tu - potrzebne w celu zapisu do EEprom

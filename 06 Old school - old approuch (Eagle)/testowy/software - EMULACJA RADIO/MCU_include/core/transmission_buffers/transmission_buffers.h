   ...
   const unsigned int16 i2c_mcu_Reception_BUFSIZE=16; //257 by³o 257 z jakiegoœ powodu, ale UART dzia³a mi z 255 //poza tym wszêdzie s¹ tak powyliczane pêtke (na int8)

...
void set_all_pack_colour(int8 colour_1)
{
   ...
   i2c_MasterBuffer[1] = command_set_all_packs;
   //MasterBuffer[2] = 0x0;
   i2c_MasterBuffer[3] = colour_1;
   //MasterBuffer[4] = 0x0;
...
{
   _HMI_i2cWritePrepare();
   i2c_MasterBuffer[1] = command_set_x_pack;
   i2c_MasterBuffer[2] = pack_no;
   i2c_MasterBuffer[3] = colour_1;
   //MasterBuffer[4] = 0x0;
   _HMI_i2cWriteExecute(i2c_HMI_LEDS_w_command_len);
}
...
{
   _HMI_i2cWritePrepare();
   i2c_MasterBuffer[1] = command_blink_all_packs;
   //MasterBuffer[2] = pack_no;
   i2c_MasterBuffer[3] = colour_1;
   i2c_MasterBuffer[4] = colour_2;
   _HMI_i2cWriteExecute(i2c_HMI_LEDS_w_command_len);
}
...
{
   _HMI_i2cWritePrepare();
   i2c_MasterBuffer[1] = command_blink_x_pack;
   i2c_MasterBuffer[2] = pack_no;
   i2c_MasterBuffer[3] = colour_1;
   i2c_MasterBuffer[4] = colour_2;
   _HMI_i2cWriteExecute(i2c_HMI_LEDS_w_command_len);
...
{
   _HMI_i2cWritePrepare();
   i2c_MasterBuffer[1] = command_clrl_all_packs;
   //MasterBuffer[2] = pack_no;
...
{
   _HMI_i2cWritePrepare();
   i2c_MasterBuffer[1] = command_clrl_x_pack;
   i2c_MasterBuffer[2] = pack_no;
   //MasterBuffer[3] = colour_1;
   //MasterBuffer[4] = colour_2;
   _HMI_i2cWriteExecute(i2c_HMI_LEDS_w_command_len);

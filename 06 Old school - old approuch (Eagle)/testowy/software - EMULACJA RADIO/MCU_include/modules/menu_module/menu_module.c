...
int1 MENU_MODULE_audio_device_init(int *which_device)
    ...
    switch (MENU_MODULE_audio_devices_list[*which_device])
        ...
        case MENU_MODULE_TEA5767_input:
            ...
            //dbg_printf("%s%u",comunicate, *which_device);
            dbg_printf("%s TEA5767",comunicate);
            
            //dbg_return_carriage();
            set_x_pack_colour(pack_1, colour_RED);
            ACTIVE_ANTENA_MODULE_active_antena_ON_TEA_5756();
            
            //if (Active_FM_antena_hardware_setup * EQU_use_active_antena_val)
        ...
        case MENU_MODULE_MONKEYBOARD_FM_input:
            ...
            dbg_printf("%s MKB_FM",comunicate);
            //dbg_return_carriage();
            set_x_pack_colour(pack_1, colour_RED);
            ACTIVE_ANTENA_MODULE_active_antena_ON_MONKEYBOARD_FM_AM();
   ...
   //         #endif
        ...
        case MENU_MODULE_MONKEYBOARD_DAB_input:
            ...
            //TODO: wy³¹czyæ wszystkie urz¹dzenia ³acznie z active antena, a po set kolor w³aczyæ w³aœciwe
            //dbg_printf("%s%u",comunicate, *which_device);
            dbg_printf("%s MKB_DAB+",comunicate);
            //dbg_return_carriage();
            set_x_pack_colour(pack_1, colour_GREEN);
            ACTIVE_ANTENA_MODULE_active_antena_ON_MONKEYBOARD_DAB();
            
            //if (EQU_use_active_antena_val * Active_DAB_antena_hardware_setup)
            //   set_x_pack_colour(pack_3, colour_RED);
  ...
  //          #endif
        ...
        case MENU_MODULE_MONKEYBOARD_AM_input:            
            ...
            //TODO: wy³¹czyæ wszystkie urz¹dzenia ³acznie z active antena, a po set kolor w³aczyæ w³aœciwe
            //dbg_printf("%s%u",comunicate, *which_device);
            dbg_printf("%s MKB_AM",comunicate);
            //dbg_return_carriage();
    ...
    //        #endif
        ...
        case MENU_MODULE_VMUSIC3_RND_input:
            ...
            //TODO: wy³¹czyæ wszystkie urz¹dzenia ³acznie z active antena, a po set kolor w³aczyæ w³aœciwe
            //dbg_printf("%s%u",comunicate, *which_device);
            dbg_printf("%s VM3_RND",comunicate);
            //dbg_return_carriage();
...
void MENU_MODULE_submenu_action(int which_submenu, int1 direction_UP_DOWN, int8 which_device)
    {
...
//#ifdef _USE_ACTIVE_ANTENA_
        case MENU_MODULE_EQUALISER_MENU_ACTIVE_ANTENA:
            ...
            case MENU_MODULE_EQUALISER_direct_DOWN:
               EQU_use_active_antena_val=EQU_use_active_antena_val-1;
               ACTIVE_ANTENA_MODULE_active_antena_OFF();
               #ifdef _USE_MNONKEYBOARD_DAB_
               if ((which_device == MENU_MODULE_MONKEYBOARD_FM_input)||(which_device == MENU_MODULE_MONKEYBOARD_AM_input)||(which_device == MENU_MODULE_MONKEYBOARD_DAB_input))
                   ACTIVE_ANTENA_MODULE_active_antena_ON_MONKEYBOARD_CONVERTER();
                #endif                   
               break;
            case MENU_MODULE_EQUALISER_direct_UP:
               ...
               #ifdef _USE_TEA5767_
               if (which_device == MENU_MODULE_TEA5767_input)
               {
                  ACTIVE_ANTENA_MODULE_active_antena_ON_TEA_5756();
               }
               #endif
               ...
               #ifdef _USE_MNONKEYBOARD_DAB_
               if ((which_device == MENU_MODULE_MONKEYBOARD_FM_input)||(which_device == MENU_MODULE_MONKEYBOARD_AM_input))
               {
                  ACTIVE_ANTENA_MODULE_active_antena_ON_MONKEYBOARD_FM_AM();
               }
               
               if (which_device == MENU_MODULE_MONKEYBOARD_DAB_input)
               {
                  ACTIVE_ANTENA_MODULE_active_antena_ON_MONKEYBOARD_DAB();
               }
               #endif
            ...
            MENU_MODULE_check_variable_boarders(&EQU_use_active_antena_val,active_antena_MIN_VAL, active_antena_MAX_VAL);         
            break;
//#endif
        ...
        case MENU_MODULE_EQUALISER_MENU_Front_Rear:
         ...
         case MENU_MODULE_EQUALISER_MENU_Backlight:
            ...
            {
            case MENU_MODULE_EQUALISER_direct_DOWN:
               EQU_Backlight_value=EQU_Backlight_value-1;
               break;
            case MENU_MODULE_EQUALISER_direct_UP:
               EQU_Backlight_value=EQU_Backlight_value+1;
               break;
            ...
            MENU_MODULE_check_variable_boarders(&EQU_Backlight_value, Backlight_MIN_VAL, Backlight_MAX_VAL);

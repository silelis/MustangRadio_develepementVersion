...
#define  EEPROM_MODULE_WRITE_active_antena();      write_ext_eeprom(Active_Antena_addr, &EQU_use_active_antena_val, Active_Antena_len);
#define  EEPROM_MODULE_READ_active_antena();       read_ext_eeprom( Active_Antena_addr, &EQU_use_active_antena_val, Active_Antena_len);
#define  EEPROM_MODULE_CHECK_active_antena();      check_read_value_int8(&EQU_use_active_antena_val, active_antena_MIN_VAL, active_antena_MAX_VAL, active_antena_MAX_VAL);
//#define  EEPROM_MODULE_R_C_active_antena();        read_and_check_value_int8(Active_Antena_addr, &EQU_use_active_antena_val, Active_Antena_len, active_antena_MIN_VAL, active_antena_MAX_VAL, active_antena_MAX_VAL);
...
#define  EEPROM_MODULE_WRITE_hmi_backlight();      write_ext_eeprom(Backlight_addr, &EQU_Backlight_value, Backlight_len);
#define  EEPROM_MODULE_READ_hmi_backlight();       read_ext_eeprom( Backlight_addr, &EQU_Backlight_value, Backlight_len);
#define  EEPROM_MODULE_CHECK_hmi_backlight();      check_read_value_int8(&EQU_Backlight_value, Backlight_MIN_VAL, Backlight_MAX_VAL, Backlight_DEFAULT_VAL);
//#define  EEPROM_MODULE_R_C__hmi_backlight();       read_and_check_value_int8(Backlight_addr, &EQU_Backlight_value, Backlight_len, Backlight_MIN_VAL, Backlight_MAX_VAL, Backlight_DEFAULT_VAL);

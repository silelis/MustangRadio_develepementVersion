...
#ifndef INC_SILELIS_CODE_MENU_RADIOMENU_H_
#define INC_SILELIS_CODE_MENU_RADIOMENU_H_
...
#define EQUALIZER_TIMEOUT_PERIOD 6

class radioMenu: public bindKeyboardToFunction {
...
private:
	...
	void menuFunction_volButLongRelease(void);
	void menuFunction_equButShortPressed(void);
	void menuFunction_volIncrement(void);
	void menuFunction_volDecrement(void);
	void menuFunction_resetToDefaultLongPress(void);
	void menuFunction_returnForEqualizerMenu(void);
...
#endif /* INC_SILELIS_CODE_MENU_RADIOMENU_H_ */

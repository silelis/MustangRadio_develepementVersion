...
#ifndef INC_SILELIS_CODE_MENU_BINDKEYBOARDTOFUNCTION_H_
#define INC_SILELIS_CODE_MENU_BINDKEYBOARDTOFUNCTION_H_
#include <iostream>
#include <functional>
#include "comunicationStructures.h"
#include <string.h>
#include <SileliS_code/menu_bindKeyboardToFunction_buttonDefinitions.h>
...
class bindKeyboardToFunction {
	friend class radioMenu;
public:
	bindKeyboardToFunction(/*_execute_t *ExecutableButtonsArray*/);
	virtual ~bindKeyboardToFunction();
...
//	static uint8_t ExecutableButtonsArrayRadioMenuArea;
	static bool radioMenuButtonsAssignedInMainMenu;

private:
	void noButtonInArrayMessage(keyboardUnion buttonSequence);
};

#endif /* INC_SILELIS_CODE_MENU_BINDKEYBOARDTOFUNCTION_H_ */

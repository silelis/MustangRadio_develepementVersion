...
class StepperOpto:private MCP23008
{
public:
	StepperOpto();
	~StepperOpto();
	...
	//esp_err_t enableMuxSelect();		//TODO: nie wiem czy w ostatecznej wersji hardware będzie to wykorzystywane, zależy od sposobu w jaki rozwiąże przełączanie I2S

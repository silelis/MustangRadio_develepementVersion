...
i2c_slave::i2c_slave()
{
	...
	assert(!i2c_reset_tx_fifo((i2c_port_t)this->i2cSlavePort)) ;
	assert(!i2c_reset_rx_fifo((i2c_port_t)this->i2cSlavePort)) ;
...
i2c_slave::~i2c_slave()
{
	assert(!i2c_driver_delete((i2c_port_t)this->i2cSlavePort)) ;
